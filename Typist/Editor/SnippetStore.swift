...
final class SnippetStore {
    ...
    private static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "Typist", category: "SnippetStore")
    ...
    private static var storageURL: URL {
        ...
        let dir = appSupport.appendingPathComponent("Typist", isDirectory: true)
