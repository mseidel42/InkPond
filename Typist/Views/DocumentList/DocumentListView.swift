...
struct DocumentListView: View {
    ...
    @Query(sort: \TypistDocument.modifiedAt, order: .reverse) var documents: [TypistDocument]

    @Binding var selectedDocument: TypistDocument?
    @Binding var searchText: String

    @State var renamingDocument: TypistDocument?
    @State var newTitle: String = ""
    @State var exporter = ExportController()
    @State var documentToDelete: TypistDocument?
